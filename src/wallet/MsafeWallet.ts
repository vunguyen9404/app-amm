...
export class MsafeWalletAdapter extends BaseWalletAdapter {
  ...
  protected _provider: MsafeWallet | undefined | any
  ...
  protected _readyState: WalletReadyState = MsafeWallet.inMsafeWallet() ? WalletReadyState.NotDetected : WalletReadyState.Unsupported

  protected _connecting: boolean

  protected _wallet: MsafeAccount | null | any
